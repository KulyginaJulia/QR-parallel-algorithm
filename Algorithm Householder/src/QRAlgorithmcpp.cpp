...
// A = GT*A
void GivensRotation::rowRotation(double*& A, double c, double s, int _i) {
...
// A = A*GT
void GivensRotation::columnRotation(double*& A, double c, double s, int _j) {
...
double GivensRotation::calculateP(double c, double s) {
	if (c == 0) {
		return 1;
	}
	else if (abs(s) < abs(c)) {
